...
import com.imaginea.kodebeagle.util.ImportsUtilBase;
...
public abstract class RefreshActionBase extends AnAction {
    ...
    protected final boolean checkFileType(final Document document, final String fileExtension) {
        ...
        if (psiInstance != null && (psiInstance.getPsiFile(document)) != null) {
            ...
            if (psiFile != null
                    && psiFile.getFileType().getDefaultExtension().equals(fileExtension)) {
                return true;
            }
        }
        return false;
