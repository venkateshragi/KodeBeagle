...
public final class KBNotification {
    ...
    private final NotificationGroup notificationsPassive = new NotificationGroup(
            RefreshActionBase.KODEBEAGLE, NotificationDisplayType.NONE, true);

    private final NotificationGroup notifications = new NotificationGroup(
            RefreshActionBase.KODEBEAGLE, NotificationDisplayType.BALLOON, true);

    private final NotificationGroup notificationsInvasive = new NotificationGroup(
            RefreshActionBase.KODEBEAGLE, NotificationDisplayType.STICKY_BALLOON, true);
    ...
    public void error(final Throwable t) {
        expire();
        prevNotification =
                notifications.createNotification(RefreshActionBase.KODEBEAGLE,
