...
public class LimitsPanel {
    ...
    private void createFields() {
        linesFromCursorSlider = new JSlider(JSlider.HORIZONTAL, LINES_FROM_CURSOR_MIN,
                LINES_FROM_CURSOR_MAX, RefreshActionBase.LINES_FROM_CURSOR_DEFAULT_VALUE);
        ...
        resultSizeSpinner.setModel(new SpinnerNumberModel(
                RefreshActionBase.SIZE_DEFAULT_VALUE, MIN, RESULT_SIZE_MAX, STEP_SIZE));
        ...
        topCountSpinner.setModel(new SpinnerNumberModel(
                RefreshActionBase.TOP_COUNT_DEFAULT_VALUE, MIN, TOP_COUNT_MAX, STEP_SIZE));
