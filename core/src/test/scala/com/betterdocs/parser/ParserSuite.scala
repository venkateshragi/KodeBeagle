...
class MethodVisitorSuite extends FunSuite with BeforeAndAfterAll {
  ...
  test("Verify method visitor includes lines with usages.") {
    ...
    assert(lines === List(79, 101, 102, 103, 105, 106, 108, 109, 112, 113, 114, 115, 117, 118, 119,
      120, 121, 123, 125, 137, 138, 139, 141, 142, 144, 145, 148, 149, 150, 152, 153, 154, 155, 156,
      158, 160, 172, 174, 177, 182, 187, 189, 191, 198, 203, 204))
  }
}
